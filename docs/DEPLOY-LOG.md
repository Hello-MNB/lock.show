...
|---|---|---|---|---|---|---|
| `rel-2026.07.09` | 9 Jul 2026 | a0d6b80 | app + site | Official channels + inboxes: social links (IG/FB/LinkedIn), WhatsApp, 11 role-based emails; JSON-LD sameAs + contactPoints; legal-page email placeholders filled. | ✅ verify green | site build ✅ · live check pending |
