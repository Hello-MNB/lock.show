...
| Site | **rel-site-2026.07.14-2 (Codex emotional-acquisition layer: entity storytelling + moment bands + measurement context, on top of the 11-page rebuild)** | **4f4ff74** — 14 Jul ~18:36 build, alias-promoted to www.lock.show + lock.show (owner directive "publish what Codex built, don't duplicate"). Source branch `codex/live-site-redesign-20260714` (tip, 5 commits ahead of 9a08069). **Rollback anchor: 9a08069** (prior live). | Codex live-site-redesign (DS logo icons, hardened mobile components, launch-quality UX pass, emotional entity storytelling, entity moment bands + measurement context) | ✅ live-verified via HTTP: 8/8 routes 200 (/, /artists, /managers, /production, /pricing, /faq, /contact, /radar), cleanUrls active, live SHA=4f4ff74 confirmed via Vercel alias resolution (browser screenshot blocked by sandbox egress policy — verified by curl) |
