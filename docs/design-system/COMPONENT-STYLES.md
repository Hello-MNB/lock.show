...
| `.data-cue` | relative transition-colors | ::before { content: '' }; ::before { position: absolute }; ::before { inset-inline-start: 0 }; ::before { top: 18% }; ::before { bottom: 18% }; ::before { width: 2px }; ::before { border-radius: 999px }; ::before { background: theme('colors.accent') }; ::before { opacity: 0 }; ::before { transform: scaleY(.55) }; ::before { transition: opacity 180ms ease, transform 180ms ease }; :hover::before { opacity: .85 }; :hover::before { transform: scaleY(1) }; :focus-within::before { opacity: .85 }; :focus-within::before { transform: scaleY(1) }; ::before { opacity: .85 }; ::before { transform: scaleY(1) } | color.accent | focus · hover | — |
...
| `.premium-panel` | rounded-2xl border border-line bg-surface/90 shadow-card backdrop-blur | — | color.line · color.surface · shadow.card | — | — |
| `.premium-stage` | relative overflow-hidden rounded-3xl border border-line bg-bg2 shadow-card | background-image: radial-gradient(60% 46% at 50% 0%, rgba(242, 192, 99, 0.08), transparent 70%), linear-gradient(180deg, rgba(255,255,255,0.018), transparent 38%) | color.bg2 · color.line · shadow.card | — | — |
...
| `useToast` | — | — | — | — |
| `Wordmark` | — | color.ink · color.muted · font.mono | — | — |

**Registry count:** 12 CSS primitives · 26 exported components — 38 rows total.
