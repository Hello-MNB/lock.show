-- GIGPROOF full schema — migrations 001..013 concatenated in order (Sun Jun 28 13:54:13 UTC 2026)

-- ============================================================
-- 001_initial_schema.sql
-- ============================================================
-- ============================================================
-- GIGPROOF — 001 Initial Schema + RLS
-- Run in Supabase → SQL Editor (once, on a fresh project).
-- Firewall: draw stored as BANDS and bounded statuses only.
-- Never add a score, percentile, rank, or exact head-count column.
-- ============================================================
...
-- ---------- passport_versions (immutable public snapshots) ----------
-- Created by the server on publish. Never updated — only new rows added.
-- The snapshot jsonb MUST NOT contain score/percentile/exact-count/internal_confidence.
...
-- profile_items: owner full; public reads passport-ok of a published artist
...
-- passport_versions: public read for published artists; service role writes (no insert policy = RLS blocks user-level insert)
...
-- ============================================================
-- 002_add_whatsapp_and_notifications.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- 005_producer_confirmations.sql
-- ============================================================
-- ============================================================
