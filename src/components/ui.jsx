...
export function Wordmark({ className = '' }) {
  // LOCK SHOW wordmark: lime "L" square (30px, rounded) + wordmark.
  ...
  // "LOCK SHOW [L]", scrambling the mark; the icon must always lead the text).
  return (
    <div dir="ltr" className={`flex items-center gap-2 ${className}`}>
      ...
      <b className="text-sm font-extrabold tracking-tight text-ink">LOCK SHOW</b>
    </div>
  )
}
