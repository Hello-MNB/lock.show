export const T = {
  ...
  authScene: {
    ...
    disclaimer: 'LOCK SHOW presents evidence only — not a guarantee.',
    homeAria: 'LOCK SHOW — go to home',
  },
  login: {
    title: 'Welcome back',
  ...
  passport: {
    ...
    // ── A15 CODEX passport ──
    eyebrow: 'LOCK SHOW · BOOKABILITY PASSPORT',
    ...
    taglineBooking: 'LOCK SHOW · FOR YOUR EVENT',
    taglineRep: 'LOCK SHOW · FOR REPRESENTATION',
    ...
    taglineProduction: 'LOCK SHOW · FOR PRODUCTION',
    taglinePrivate: 'LOCK SHOW · FOR PRIVATE & CORPORATE EVENTS',
  ...
  request: {
    ...
    whatsappMsg: (artistName, requesterName) => `Hi ${artistName}, my name is ${requesterName} and I'd like to coordinate a show. I also sent an availability request via LOCK SHOW.`,
  ...
  agency: {
    ...
    inviteFieldLabel: "Artist's Passport link or LOCK SHOW ID",
    inviteFieldHint: 'Paste the link you already have — LOCK SHOW never surfaces a cold directory of artists to browse.',
    ...
    quickAddHint: "Use this only if the artist doesn't have their own LOCK SHOW account yet — this creates a roster entry with no separate artist login or approval control.",
  ...
  booker: {
    ...
    whatIsTitle: 'What is a LOCK SHOW passport?',
  ...
  consent: {
    ...
    subtitle: 'LOCK SHOW requires explicit consent before any data collection.',
    privacyTitle: 'Privacy Policy',
    privacy: 'I have read and agree to the LOCK SHOW Privacy Policy (DRAFT — pending legal counsel).',
    processingTitle: 'Data Processing',
    processing: 'I agree to the processing of the information I provide to build my LOCK SHOW profile.',
    ...
    marketing: 'I agree to receive updates from LOCK SHOW products (cancellable at any time).',
    ...
    inlineAgree: 'I agree to the LOCK SHOW Privacy Policy and to the processing of the information I provide to build my profile.',
  ...
  org: {
    ...
    planPilotNote: 'The pilot is free — no payment is required to publish or use LOCK SHOW.',
