export const T = {
  ...
  roleSelect: {
    ...
    jobArtistDescription: 'Explore your activity as an artist and choose what to focus on.',
    ...
    jobSelectionHelp: 'Choose based on what you want to do now.',
    jobEyebrow: 'Getting started',
  },
  demo: {
  ...
  onboarding: {
    entryRetry: 'Nothing further was confirmed. Keep your details and try again.',
    entryUncertain: 'The result is not yet known. Check the saved result before continuing.',
    entryRecover: 'Check saved result',
    entryLinkError: 'This link could not be captured. Check the link and your access, or continue without it.',
    entrySourceConsent: 'I have permission to submit this source for private review.',
    entryWithoutLink: 'Continue without a link',
    entryNoticeUnavailable: 'The current service notice is unavailable. No profile details can be submitted yet.',
    entryTerms: 'Service terms',
    entryDecline: 'Decline this use',
    entryDecisionSaved: 'Your decision was recorded. This profile capability remains unavailable; your account and draft are preserved.',
    ...
    entryStepLabels: ['Who you are', 'Strongest link', 'Saved candidate'],
    // T-58 — step 3, the reveal (§8.1). Real captured data only, never a tally.
    revealTitle: 'Your link was saved',
    revealSub: 'Saved as a candidate for private review in your Radar. It has not been verified, confirmed or published.',
    revealRowSub: 'Artist-supplied link — candidate',
    revealFound: 'Saved',
    ...
    entryLinkHint: 'Add one link for private review, or continue without one. Saving it does not verify its contents.',
  ...
  dashboard: {
    ...
    unpublishedBadge: 'Changes saved privately — the public version is unchanged',
    publishedHint: 'Your public Passport is a signed version. Safe replacement requires unpublishing, then publishing a new version.',
  ...
  agency: {
    ...
    inviteTabInvite: 'Already on LOCK',
    inviteTabNew: 'Not on LOCK yet',
    ...
    inviteEmailLabel: 'Artist email',
    inviteCreateLink: 'Create invitation',
    inviteDelivered: 'Invitation sent — awaiting the Artist.',
    inviteLinkReady: 'Invitation link ready to share.',
    inviteReadyTitle: 'Invitation ready',
    inviteReadyBody: 'The Artist can create an account, review the requested access, and accept or decline.',
    inviteLinkLabel: 'Artist invitation link',
    ...
    inviteForbidden: 'Only a Workspace owner or admin can invite an Artist.',
    rosterInviteEyebrow: 'Roster invitation',
    rosterInviteTitle: 'Join a representation roster',
    rosterInviteBody: (organization, artist) => `${organization} invited ${artist} to connect an Artist workspace.`,
    rosterInviteAccessTitle: 'Access requested',
    rosterInviteBoundary: 'You stay in control. Nothing is shared until you accept, and this is not a booking or commitment.',
    rosterInviteCreateAccount: 'Create an Artist account',
    rosterInviteSignIn: 'I already have an account',
    rosterInviteCreateArtist: 'Set up my Artist workspace',
    rosterInviteSelectArtist: 'Which Artist workspace should join this roster?',
    rosterInviteSelectRequired: 'Choose the Artist workspace you want to connect.',
    rosterInviteUnnamedArtist: 'Untitled Artist workspace',
    rosterInviteApprovalSummary: (artist) => `You are approving the requested access for ${artist}.`,
    rosterInviteAccept: 'Accept invitation',
    rosterInviteDecline: 'Decline',
    rosterInviteAcceptedTitle: 'Roster access approved',
    rosterInviteAcceptedBody: 'Your Artist workspace is now connected with the access you approved.',
    rosterInviteDeclinedTitle: 'Invitation declined',
    rosterInviteDeclinedBody: 'No access was granted and no Artist data was shared.',
    rosterInviteContinue: 'Continue to LOCK SHOW',
    rosterInviteWrongAccount: 'Sign in with the email address that received this invitation.',
    rosterInviteUnavailable: 'This invitation is no longer available.',
    rosterInviteLoadError: 'We could not open this invitation.',
    rosterInviteActionError: 'The invitation could not be updated. Try again.',
  ...
  claims: {
    ...
    applyBody: 'The public version is unchanged. To replace it safely, unpublish it, then publish a new version.',
  ...
  org: {
    ...
    switchPreflightTitle: 'Review workspace switch',
    switchPreflightBody: (name) => `Switch to ${name}? The server will recheck your current access before anything changes.`,
    switchFrom: 'Current',
    switchTo: 'Next',
    switchConfirm: 'Confirm switch',
    switchPreparing: 'Checking access…',
    switchCommitting: 'Switching…',
    switchPreserveNote: 'Your current workspace, draft, filters and focus stay in place unless a server receipt confirms the switch.',
    switchActive: 'Current workspace',
    switchSuccess: (name) => `Switched to ${name}.`,
    switchErrorOffline: 'You are offline. Nothing changed. Reconnect and try again.',
    switchErrorStale: 'Your workspace context changed elsewhere. Nothing changed here; review the refreshed list and try again.',
    switchErrorUncertain: 'The current workspace could not be confirmed. Workspace actions are paused; your prior draft is preserved. Check the server context before continuing. This does not submit another switch.',
    switchUnresolvedTitle: 'Workspace confirmation required',
    switchRecover: 'Check current workspace',
    switchRecovering: 'Checking current workspace…',
    switchErrorRefresh: 'The server committed the switch, but this view could not refresh. Reload to read the current server context.',
    switchErrorGeneric: 'That workspace is not available. Nothing changed.',
    contextBeaconLabel: 'Current person, role, environment and workspace',
    contextPersonLabel: 'Signed in as',
    contextWorkspaceLabel: 'Workspace',
    contextRoleLabel: 'Active role',
    contextEnvironmentLabel: 'Environment',
    contextPersonFallback: 'Signed-in person',
    contextNoWorkspace: 'Workspace not resolved',
    contextRolePending: 'Role pending',
    contextRoleArtist: 'Artist / Act',
    contextRoleRepresentation: 'Representation',
    contextRoleBuyer: 'Buyer / Recipient',
    contextRoleConfirmer: 'Source confirmer',
    contextRoleOperator: 'Platform operator',
    contextRoleAdmin: 'Authorized Admin',
    contextWorkspaceArtist: 'Artist / Act workspace',
    contextWorkspaceRepresentation: 'Representation workspace',
    contextWorkspaceProduction: 'Production workspace',
    contextWorkspaceAdmin: 'Private Admin environment',
    contextWorkspaceGeneric: 'Workspace',
    contextEnvironmentProduction: 'Live system',
  ...
  radar: {
    ...
    firstValue: {
      privateLabel: 'Private Artist workspace · evidence, not a score',
      question: 'What does the evidence support for this Act and goal now?',
      context: (act, workspace) => `${act || 'Current Act'} · ${workspace || 'Current Artist workspace'} · Artist role`,
      goal: (goal) => `Goal: ${goal}`,
      goalUnknown: 'Not set yet — evidence stays visible without guessing a goal',
      evidenceEmpty: 'No eligible evidence yet',
      evidenceThin: 'Evidence is partial',
      evidenceSupported: 'Supported evidence is available',
      evidenceFresh: 'current evidence',
      evidenceStale: 'refresh needed',
      evidenceUnknown: 'freshness not established',
      methodLimit: 'Sources, method and limits remain inspectable; no Artist rank or booking promise.',
      next: (action) => `Safest next step: ${action}`,
      noAction: 'No action for now',
      noActionReceipt: 'No action selected. Nothing was changed or published. You can resume safely.',
      resume: 'Review again',
      wrongWorkspace: 'This private Artist Radar is not available in the active workspace.',
      revoked: 'Your access to this Artist workspace was revoked.',
      retry: 'Retry this private view',
      safeReturn: 'Return to my workspace',
    },
